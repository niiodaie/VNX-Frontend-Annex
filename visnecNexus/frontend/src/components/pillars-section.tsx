...
export default function PillarsSection() {
  const pillars = [
    ...
    {
      id: "platforms",
      path: "https://platforms.visnec.ai",
      icon: "🧩",
      title: "Platforms",
    ...
    {
      id: "directories",
      path: "https://directories.visnec.ai",
      icon: "📚",
      title: "Directories",
    ...
    {
      id: "resources",
      path: "https://resources.visnec.ai",
      icon: "🗂️",
      title: "Resources",
    ...
    {
      id: "community",
      path: "https://community.visnec.ai",
      icon: "🧑‍🤝‍🧑",
      title: "Community",
    ...
    {
      id: "marketplace",
      path: "https://marketplace.visnec.ai",
      icon: "🛒",
      title: "Marketplace",
    ...
    {
      id: "experiences",
      path: "https://experiences.visnec.ai",
      icon: "✨",
      title: "Experiences",
